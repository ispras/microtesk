...
public final class sw48 extends Operation {
  private static final class Info extends InfoAndRule {
    Info()
    {
        super(
           ...
           true,
           new ParamDecls()
               .declareParam("rd", ArgumentMode.IN, r48.INFO)
  ...
  public sw48(IAddressingMode rd, Location addr)
  {
  ...
  {
      return String.format("sw48 %s, %x", rd.syntax(), addr.load().getRawData().longValue());
  }

  @Override
  public void action()
  {
      M48.access(addr.load()).store(rd.access().load());
  }
}
