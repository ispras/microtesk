 ...
 * All rights reserved.
 *
 * $Id: Int32ArrayIterator.java,v 1.4 2008/08/18 08:08:34 kamkin Exp $
 */

package com.unitesk.testfusion.core.iterator;

/**
 * Iterator of <code>int[]</code> array items.
 * 
 * @author <a href="mailto:kamkin@ispras.ru">Alexander Kamkin</a>
 */
public class Int32ArrayIterator extends Int32Iterator
{
    /** Iterated array. */
    protected int[] array;
     ...
     */
	public Int32ArrayIterator(int[] array)
	{
     ...
     */
	protected Int32ArrayIterator(Int32ArrayIterator r)
    {
        int i, size;
     ...
     */
    public Int32ArrayIterator clone()
    {
