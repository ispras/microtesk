 ...
 * All rights reserved.
 *
 * $Id: DoubleArrayIterator.java,v 1.4 2008/08/18 08:08:34 kamkin Exp $
 */

package com.unitesk.testfusion.core.iterator;

/**
 * Iterator of <code>double[]</code> array items.
 * 
 * @author <a href="mailto:kamkin@ispras.ru">Alexander Kamkin</a>
 */
public class DoubleArrayIterator extends DoubleIterator
{
    /** Iterated array. */
     ...
     */
    protected DoubleArrayIterator(DoubleArrayIterator r)
    {
        int i, size;
     ...
     */
    public DoubleArrayIterator clone()
    {
