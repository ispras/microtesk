 ...
 * All rights reserved.
 *
 * $Id: Register64.java,v 1.6 2009/04/09 08:38:29 kamkin Exp $
 */
...
/**
 * 64-bit register of microprocessor. 
 * 
 * @author <a href="mailto:kamkin@ispras.ru">Alexander Kamkin</a>
 */
public class Register64 implements Register
{
    /**
    ...
    public static class Field
    {
        ...
        public Field(int min, int max)
        {
            ...
            this.mask = ((0xffffffffffffffffL << 63 - max) >>> 63 - max + min) << min;
        }
    ...
    {
        setLongValue(Double.doubleToRawLongBits(value));
    }
     ...
     */
    public long getFieldValue(Field field)
    {
     ...
     */
    public void setFieldValue(Field field, long value)
    {
     ...
     */
    public Register64 clone()
    {
        return new Register64(value);
    }
}
