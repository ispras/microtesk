...
public final class GeneratorC implements TranslatorHandler<Ir> {
  private final Translator<Ir> translator;
  private Ir ir;
  private GeneratorFactory factory;

  public GeneratorC(final Translator<Ir> translator) {
  ...
  public void processIr(final Ir ir) {
    ...
    this.factory = new GeneratorFactory(
        translator.getOutDir() + "/src/c", ir.getModelName());
