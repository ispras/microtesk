...
package ru.ispras.microtesk.test.mmu.sequence.iterator;
...
import ru.ispras.microtesk.test.mmu.sequence.Template;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterAccessThenMiss;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterBuilder;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterHitAndTagReplaced;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterHitAndTagReplacedEx;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterMultipleTagReplaced;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterMultipleTagReplacedEx;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterNonReplaceableTagEqual;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterParentMissChildHitOrReplace;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterTagEqualTagReplaced;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterUnclosedEqualRelations;
import ru.ispras.microtesk.test.mmu.sequence.filter.FilterVaEqualPaNotEqual;
...
import ru.ispras.microtesk.translator.mmu.ir.spec.basis.DataType;
 ...
 * 
 * <p>The template iterator systematically enumerates templates to cover a representative set of
...
public final class AbstractSequenceIterator implements Iterator<Template> {
  ...
  private Predicate<Template> executionPairFilter;
  /** Checks the consistency of whole test templates. */
  private Predicate<Template> wholeTemplateFilter;
   ...
   */
  public List<Dependency> getDependencies(final ExecutionPath execution1,
