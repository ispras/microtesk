 ...
 */
public final class MmuConflict {
   ...
   */
  public MmuConflict(final Type type, final MmuDevice device, final MmuCondition condition) {
   ...
   * @throws NullPointerException if some parameters are null.
   */
  public MmuConflict(final Type type, final MmuAddress address, final MmuCondition condition) {
    InvariantChecks.checkNotNull(type);
  ...
  public boolean equals(final Object o) {
    ...
    if (o == null || !(o instanceof MmuConflict)) {
      return false;
    }

    final MmuConflict r = (MmuConflict) o;
