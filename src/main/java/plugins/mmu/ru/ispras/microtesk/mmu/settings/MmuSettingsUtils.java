...
public final class MmuSettingsUtils {
  ...
  public static Node getVariableConstraint(
    ...
    final Restriction.Kind kind = include.isEmpty()
        ? Restriction.Kind.EXCLUDE
        : Restriction.Kind.RETAIN;
    ...
    return Restriction.domain(kind, variable, bvDomain, bvValues);
  }
  ...
  public static Node getVariableConstraint(
    ...
    return Restriction.domain(Restriction.Kind.RETAIN, variable, null, values);
  }
