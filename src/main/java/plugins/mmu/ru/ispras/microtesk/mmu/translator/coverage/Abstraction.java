...
/**
 * {@link Abstraction} is an interface for abstracting memory access path transitions.
 * 
 ...
 */
public interface Abstraction<T> extends Function<MmuTransition, T> {
  // T apply(final MmuTransition transition);
}
