 ...
 * All rights reserved.
 * 
 * FormatMarker.java, Aug 8, 2014 2:06:50 PM Andrei Tatarnikov
 * 
...
/**
 * The FormatMarker class provides facilities to identify markers within
 * a format string. Currently, the following markers are supported:
 * %b, %d, %x and %s.
 * 
