...
class OpInstance {
  ...
  private static OpInstance createInstance(PrimitiveAND image, List<String> order,
      Map<String, List<OpInstance>> instances) {
    final OpInstance op =
  ...
  private static List<OpInstance> instantiateOR(Primitive p,
      Map<String, List<OpInstance>> instances) {
  ...
  private static List<OpInstance> instantiateAND(Primitive p,
      Map<String, List<OpInstance>> instances) {
