...
public class SymbolTypeMismatch implements ISemanticError
{
    ...
    private final ru.ispras.microtesk.translator.mmu.translator.ESymbolKind         kind;
    private final ESymbolKind expectedKind;

    public SymbolTypeMismatch(String symbolName, ru.ispras.microtesk.translator.mmu.translator.ESymbolKind eSymbolKind, ESymbolKind expectedKind2)
    {
