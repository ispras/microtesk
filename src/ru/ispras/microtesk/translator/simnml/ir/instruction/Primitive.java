 ...
 * All rights reserved.
 * 
 * Primitive.java, Jan 11, 2013 4:56:38 PM Andrei Tatarnikov
 */
...
public final class Primitive
{
    ...
    public Primitive(String name, EArgumentKind kind)
    {
        this.name = name;
        this.kind = kind;
        this.args = new LinkedHashMap<String, Primitive>();
    }
    ...
    public Primitive(Primitive primitive)
    {
        ...
        for (Map.Entry<String, Primitive> e : primitive.args.entrySet())
            this.args.put(e.getKey(), new Primitive(e.getValue()));
    }
    ...
    public void addArgument(String argName, Primitive argType)
    {
        assert !args.containsKey(argName);
        args.put(argName, argType);
    }

    public void resetArgument(String argName, Primitive argType)
    {
        assert args.containsKey(argName);
        args.put(argName, argType);
    }
