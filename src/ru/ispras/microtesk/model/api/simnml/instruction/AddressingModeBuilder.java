 ...
 * All rights reserved.
 * 
 * AddressingModeBuilder.java, Nov 19, 2012 3:58:09 PM Andrei Tatarnikov
 */
...
/**
 * The AddressingModeBuilder class implements logic responsible for creating and
 * initializing addressing mode objects. 
 * 
...
public final class AddressingModeBuilder implements IAddressingModeBuilderEx
{
    ...
    public AddressingModeBuilder(String modeName, IAddressingMode.IFactory factory, Map<String, Type> decls)
    {
    ...
    private void checkUndeclaredArgument(String name) throws UndeclaredException
    {
        final String ERROR_FORMAT = 
            "The %s argument is not declared for the %s addressing mode.";
    ...
    {
        final String ERROR_FORMAT =
            "The % argument of the %s mode is not initialized.";
