...
Also, here is the list of runtime methods what has been defined by the \texttt{define{\_}type},
\texttt{define{\_}space} and \texttt{define{\_}ascii{\_}string} methods in the previous example:
